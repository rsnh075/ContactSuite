    ...
    mounted: function(el, binding) {
        ...
        const _validateForm = e => {
            let _formNotValidCount = 0,
                _nrOfFields = _fieldsToValidate.length,
        ...
        const _validateToSubmit = () => {
            //reassess form for fields to validate (fields may have been changed)
            _fieldsToValidate = [].slice.call(
                el.querySelectorAll('[data-validate]')
            );
            //add fields thad may have been added or substracted
            setMessageBalloons();
