...
const playAudio = evt => {
    ...
    const _playPrompt = id => {
        ...
        IPCCCConfigurator.Request(props.selectedcustomerid, 'prompts', 'playprompt', LanguageCode.Nederlands, id).then(soundUrl => {
