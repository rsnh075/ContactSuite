<template>
  <div class="switchabletextarea-wrapper" data-e2e="switch-table-text-field">
    <div class="form-textfield form-textfield--bground">
        <input type="text" v-model="theValue" :disabled=!isActive>
        <label class="form-label form-label--hidden">{{ label }}</label>
      </div>
