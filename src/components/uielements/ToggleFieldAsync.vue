<template>
  <div class="togglefield-button" data-e2e="toggle-field-button-async">
    <input type="checkbox"
      :id="`togglefield__${guid}`"
      name="togglefield"
      :checked="modelValue"
      @click="$emit('togglefieldClicked');"
      :data-e2e="datae2e"
    >
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    emits: ['togglefieldClicked'],
    setup() {
      const guid = ref(generateQuickGuid());
